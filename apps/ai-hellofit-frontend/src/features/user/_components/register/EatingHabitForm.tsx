    ...
    <section className={styles.page_layout}>
      <section className={styles.top_wrapper}>
        ...
        <section className={styles.button_select_list}>
          <ActiveButton name={"균형 있게 먹어요!"} />
          <ActiveButton name={"고기 위주로 먹어요."} />
          <ActiveButton name={"채소 위주로 먹어요."} />
          <ActiveButton name={"기름진 음식을 자주 먹어요."} />
          <ActiveButton name={"식사가 불규칙해요."} />
          <ActiveButton name={"탄수화물 위주로 먹어요."} />
        </section>
      </section>
